...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_eval_results', type=str, default='', help="output file for eval results; if not empty, json input will be augmented with has_answer field and output to this file")
    args = parser.parse_args()

    evaluate_retrieval(args.retrieval, args.topk, args.regex, args.output_eval_results)
